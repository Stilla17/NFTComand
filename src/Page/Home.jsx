...
import foto from './../assets/word-logo-gradient-background-1200x630.png';
import { Pagination } from 'swiper/modules';
import { Swiper, SwiperSlide } from 'swiper/react';
import just from './../assets/film-strip-perspective-cinema-movie-260nw-2547958721.webp';
import just1 from './../assets/5502524-cinema-background-concept-movie-theatre-object-on-red-rideau-background-and-movie-time-with-electric-bulbs-frame-vector-illustration-gratuit-vectoriel.jpg';
import 'swiper/css';
    ...
    
        {
          data?.map((item, index) => (
            <div key={index} className='flex pt-3 '>
              ...
              <SwiperSlide key={index} className='pt-5'><img className='w-250 h-90 rounded-2xl m-auto' src={`${img_300}/${item.backdrop_path}`} alt="" /></SwiperSlide>
