  ...
  return (
    <div className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-white transition-colors duration-300">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-primary/10 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 h-16 flex items-center justify-between gap-4 md:gap-8">
          {/* Logo */}
          ...
          <div className="flex-1 space-y-6 md:space-y-8">
            ...
            <section className="relative overflow-hidden rounded-xl h-[280px] sm:h-[360px] md:h-[480px] group">
              <div
                ...
                style={{
                  backgroundImage:
                    'linear-gradient(to right, rgba(15, 35, 15, 0.95) 20%, rgba(15, 35, 15, 0.2) 60%, rgba(15, 35, 15, 0.95) 100%), url("https://lh3.googleusercontent.com/aida-public/AB6AXuDeA3nIUL176a99Wy6VKgC93LMCRgFDwou95wO5IbsVnK-y9l4ItErNflhZGrvI8F6_4dB0thzqfayguSpVKVmkc-Ytfky2GmNSrar_Z7Uz8m0Vi0vEOiZb1Ui7XxFClB2-MO53JuC8nXru_zLjs-ipu53o_e4EbohmkV0mIt1pWlGRPC0n_5jkacop5VJ_8Zp0Eau6h-g2swOGfv5J2d7CqwZ_1OWRRD-vD3fHRh-QywCG0Vf6x3IxtMFOWzwE1uahBYGkvlJRcqzZ");'
                }}
              ></div>
