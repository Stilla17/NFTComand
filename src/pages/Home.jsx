            ...
            <main className="max-w-[1440px] mx-auto px-6 py-8 ">
                ...
                <div className='flex justify-center pt-30 gap-50'>
                    ...
                    <div className="flex gap-5 ">
                        ...
                        <div>
                            <img className='rounded-lg' src={Game1} alt="" />
                        </div>
                        ...
                        <div>
                            ...
                            <h1 className='w-30 text-5xl pt-2'>Cyberpunk Legends: Resurgence</h1>
                            <p className='w-100 pt-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque?</p>
